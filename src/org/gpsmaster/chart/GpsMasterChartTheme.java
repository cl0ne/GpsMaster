 ...
 * 22-Jul-2014 : GspMasterChartTheme (rfu)
 */
 ...
 * @since 1.0.11
 */
public class GpsMasterChartTheme implements ChartTheme, Cloneable,
    ...
    /**
     * The largest font size.  Use for the main chart label.
     */
    ...
    /** The paint used to display the main chart label. */
     ...
     */
    public GpsMasterChartTheme(String name) {
        this(name, false);
    }
    ...
    public GpsMasterChartTheme(String name, boolean shadow) {
        ...
        this.regularFont = new Font("Tahoma", Font.PLAIN, 10);
        this.smallFont = new Font("Tahoma", Font.PLAIN, 8);
        ...
        this.plotBackgroundPaint = Color.WHITE; // Color.lightGray;
        ...
        this.domainGridlinePaint = Color.GRAY; // Color.white;
        this.rangeGridlinePaint = Color.GRAY; // Color.white;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof GpsMasterChartTheme)) {
            return false;
        }
        GpsMasterChartTheme that = (GpsMasterChartTheme) obj;
